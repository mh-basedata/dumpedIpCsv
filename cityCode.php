...
/*
  ...
  +----------------------------------------------------------------------+
 */
$provinceCode=array( // 注：内蒙可能全写为内蒙古 
    '0000' => '未知',
...
$cityList = array (
    ...
    "内蒙古"=>array("呼和浩特","包头","乌海","赤峰","呼伦贝尔盟","阿拉善盟","哲里木盟","兴安盟","乌兰察布盟","锡林郭勒盟","巴彦淖尔盟","鄂尔多斯","通辽"),
    ...
    "江西"=>array("南昌","景德镇","九江","鹰潭","萍乡","新馀","赣州","吉安","宜春","抚州","上饶","新余"),
    "山东"=>array("济南","青岛","淄博","枣庄","东营","烟台","潍坊","济宁","泰安","威海","日照","莱芜","临沂","德州","聊城","滨州","菏泽"),
    "河南"=>array("郑州","开封","洛阳","平顶山","安阳","鹤壁","新乡","焦作","濮阳","许昌","漯河","三门峡","南阳","商丘","信阳","周口","驻马店","济源","河南省直辖县级行政区划"),
    "湖北"=>array("武汉","鄂州","宜昌","荆州","襄樊","黄石","荆门","黄冈","十堰","恩施","潜江","天门","仙桃","随州","咸宁","孝感","湖北省直辖县级行政区划"),
    ...
    "广西"=>array("南宁","柳州","桂林","梧州","北海","防城港","钦州","贵港","玉林","南宁地区","柳州地区","贺州","百色","河池","来宾","崇左"),
    "海南"=>array("海口","三亚","海南省直辖县级行政区划"),
    "四川"=>array("成都","绵阳","德阳","自贡","攀枝花","广元","内江","乐山","南充","宜宾","广安","达川","雅安","眉山","甘孜","凉山","泸州","遂宁","达州","巴中","资阳","阿坝藏族羌族自治州"),
    "贵州"=>array("贵阳","六盘水","遵义","安顺","铜仁","黔西南","毕节","黔东南","黔南"),
    "云南"=>array("昆明","大理","曲靖","玉溪","昭通","楚雄","红河","文山","思茅","西双版纳","保山","德宏","丽江","怒江","迪庆","临沧","普洱"),
    "西藏"=>array("拉萨","日喀则","山南","林芝","昌都","阿里","那曲"),
    ...
    "新疆"=>array("乌鲁木齐","石河子","克拉玛依","伊犁","巴音郭勒","昌吉","克孜勒苏柯尔克孜","博尔塔拉","吐鲁番","哈密","喀什","和田","阿克苏","巴音郭楞蒙古自治州","塔城","阿勒泰","新疆维吾尔自治区直辖县级行政区划"),
    "香港"=>array("香港"),
    "澳门"=>array("澳门"),
    "台湾"=>array("台北","高雄","台中","台南","屏东","南投","云林","新竹","彰化","苗栗","嘉义","花莲","桃园","宜兰","基隆","台东","金门","马祖","澎湖"),
);
$cityList2=array(
    "00000000" => "未知",
    "00010000" => "北京",
